...
class AtheriaEconomyEngine:
    def __init__(
        ...
        self.last_refresh_year: int | None = None
    ...
    def load_dict(self, data: Dict[str, Any]) -> None:
        ...
        self.last_refresh_year = int(data["last_refresh_year"]) if data.get("last_refresh_year") is not None else None
    ...
    def _build_state(
        ...
        *,
        ...
        if refreshed:
            ...
            source = "ATHERIA fortgeschrieben"
        else:
        ...
        if self.last_error and not refreshed:
